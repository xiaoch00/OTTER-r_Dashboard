...
#DK Data
DKdata <- read.csv(file = '/Volumes/psy-ctn/psy-ctn/SNAPLab/SNAP Projects/SEAL/00_rSEAL/02_rSEAL_Data/Wave_1/RedCap/DK_Log/rSEALDKLOG_06AUG2020.csv')
...
Attempt3Plot <- barplot(Attempt3, beside = TRUE, main = "Attempt 3 Statuses",
        col = c("#8DA0CB","#e78ac3"),
         xlab = " ",
        ylab = "Count", legend = c( "Non-responsive/Disconnected", "Scheduled"),
