...
#DK Data
DKdata <- read.csv(file = '/Volumes/psy-ctn/psy-ctn/SNAPLab/SNAP Projects/SEAL/00_rSEAL/02_rSEAL_Data/Wave_1/RedCap/DK_Log/rSEALDKLOG_15SEPT2020.csv')
...
DKParsedData$eligibility <- ifelse(DKParsedData$rseal_dklog_012 == '1' & DKParsedData$rseal_dklog_013 == '1' & DKParsedData$rseal_dklog_014 == '1' & DKParsedData$rseal_dklog_015 == '1' & DKParsedData$rseal_dklog_018 == '1' & DKParsedData$rseal_dklog_020 == '1' & DKParsedData$rseal_dklog_021 == '1', TRUE,FALSE)


Eligible <- subset(DKParsedData, DKParsedData$eligibility == 1| DKParsedData$rseal_dklog_038 == '1')
...
<font size = "4"> There are currently <font size="4" color="red"> **`r papaja::printnum(Ntotal)`**</font> potential participants in DK LOG, <font size="4" color="red"> **`r papaja::printnum(AttemptContact2)`**</font> of whom have been contacted and <font size="4" color="red"> **`r papaja::printnum(Eligible)`**</font> have been confirmed as eligible.</font>
...
Attempt1Plot <- barplot(Attempt1, beside = TRUE, main = "Attempt 1 Statuses",
        ...
        args.legend = list(x="topright", cex=.7),ylim=c(0,100), xaxt = "n")
...
Attempt2Plot <- barplot(Attempt2,
        ...
        xlab = " ",
        ylab = "Count", legend = c("Contact family","Requested Call Back", "Non-responsive/Disconnected", "Scheduled", "Not Interested", "Ineligible"),
        args.legend = list(x="topright", cex=.7), ylim=c(0,60),
        xaxt = "n")
