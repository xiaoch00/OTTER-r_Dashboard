...
#DK Data
DKdata <- read.csv(file = '/Volumes/psy-ctn/psy-ctn/SNAPLab/SNAP Projects/SEAL/00_rSEAL/02_rSEAL_Data/Wave_1/RedCap/DK_Log/rSEALDKLOG_17AUG2020.csv')
...
Attempt1Plot <- barplot(Attempt1, beside = TRUE, main = "Attempt 1 Statuses",
        ...
        args.legend = list(x="topright", cex=.7),ylim=c(0,60), xaxt = "n")
